...
if os.path.isfile("standard.txt"):
    ...
    app = input("\ngebruik je de trello tijd extentie?\n klik enter als je het gebruikt, vul iets al gebruik je het niet")
...
if reuse1 == "yeet":
    file.write("\n\n\n\n\nPlanning\n")
    trello1 = input("\nzeg niets (dus een directe enter) als je trello hebt gebruikt")
    if trello1 == "":
        trello1 = "True"
        file.write("\nIs er een planning gemaakt (op Trelle): ja\n")
        trello2 = input("\nzeg niets als de kaartjes op tijd ingesteld zijn")
        if trello2 == "":
            trello2 = "True"
        ...
        trello3 = input("\nzeg niets als de planning goed is bijgehouden")
        if trello3 == "":
            trello3 = "True"
            file.write("\nIs de planning (goed) bijgehouden: ja\n")
        else:
            file.write("\nIs de planning (goed) bijgehouden: nee\n")
        trello4 = input("\nzeg niets als er bij inlevering een link naar je trello aanwezig is")
        if trello4 == "":
            trello4 = "True"
    ...
    file.write("\n\n\n\n\nGithub\n")
    github1 = input("\nzeg niets (dus een directe enter) als je een REPO hebt gemaakt op github")
    if github1 == "":
        github1 = "True"
        file.write("\nIs er een REPO gemaakt voor de opdracht: ja\n")
        github2 = input("\nzeg niets als je meerdere commits hebt gebruikt")
        if github2 == "":
            github2 = "True"
            file.write("\nZijn er meerdere commints aanwezig: ja\n")
        else:
            file.write("\nZijn er meerdere commints aanwezig: nee\n")
        github3 = input("\nzeg niets als je commits goede beschrijvingen hebben")
        if github3 == "":
            github3 = "True"
            file.write("\nZijn er goede beschrijvingen aanwezig bij de commints: ja\n")
        else:
            file.write("\nZijn er goede beschrijvingen aanwezig bij de commints: nee\n")
        github4 = input("\nzeg niets als je bij het inleveren je een link naar je REPO hebt ingeleverd")
        if github4 == "":
            github4 = "True"
